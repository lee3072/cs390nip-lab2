...
# DATASET = "mnist_d"        #net: 97.68; conv: 98.70/99
# DATASET = "mnist_f"          #net: 87.05; conv: 88.30/90
# DATASET = "cifar_10"       #net: 10.00; conv: 70.21/70
# DATASET = "cifar_100_f"    #net: 1.00; conv: 25.15/30
DATASET = "cifar_100_c"    #net: 5.00; conv: 38.94/50
...
def buildTFConvNet(x, y, eps = 350, dropout = True, dropRate = 0.43):
    ...
    model.add(keras.layers.Conv2D(24, kernel_size = (3,3), activation = "relu"))
    ...
    model.add(keras.layers.Conv2D(40, kernel_size = (3,3), activation = "relu"))
